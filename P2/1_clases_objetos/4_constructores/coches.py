...
METODO CONSTRUCTOR.- este metodo especial dentro de una clase y se utiliza para dar un valor alos atributos del objeto
al crarlo, es el primer metodo que se ejecuta al crear el objeto y se manda llamar automaticamente al 
crearlo es decir este metodo puede recibir parametros al momento de crear el objeto.

cuando se crear un metodo constructor se utiliza la funcion init(), para que se llame automaticamente cada vez
que se utiliza la clase para crear un nuevo objeto.
