...
""" METODO CONSTRUCTOR.- Este metodo especial dentro de una clase y se utiliza para
 dar un valor a los atributos del objeto al crearlo es el primer metodo que se 
 ejecuta al crear el objeto y se manda llamar automaticamente al crearlo,
 es decir este metodo puede recibir parametros al momento de crear el objeto"""

""" Cuando se crear-un-metodo constructor se utiliza la funcion init(), para que
 se llame automáticamente cada vez que se utiliza la clase para crear un nuevo objeto."""

"""El-self-es-un parámetro es una referencia a la instancia-actual-de-la-clase
y se utiliza para acceder a variables que pertenecen-a-la-clase."""

"""No es necesario que tenga nombre self, puedes llamarlo como quieras, pero tiene
que ser el primer parámetro de cualquier función de la clase. Es decir por
regla se utiliza-en-la palabra self-pero puede ser llamado con otro nombre por
ejemplo: valor, abd, parametro, etc."""
...
class Coches:
 ...
 #El encapsulaiento o visibilidad es importante por que a traves 
 # de el es posible que python sepa como va a utilizar y manipular
 #  los atributos y metodos de la clase
    ...
    #Nota 1: Para utilizar un atributo provado es necesario usarlo dentro de un metodo publico
    ...
    def __MetodoPrivado(self):
      ...
      #Nota 2: Para utiliza un metodo privado es necesario usarlo dentro de un metodo publico
